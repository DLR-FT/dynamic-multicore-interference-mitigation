...
const IS_FEAT_TEBF0818: LazyCell<bool> =
    LazyCell::new(|| env::var("CARGO_FEATURE_TEBF0818").is_ok());
...
pub fn main() {
    let memory_ld = if *IS_FEAT_QEMU {
        quote! {
            ...
            __HEAP_SIZE = 0x20000000;
            __TEXT_OFFSET = 0x40000000;
        }
    } else if *IS_FEAT_KR260 || *IS_FEAT_TEBF0818 {
        quote! {
            __NUM_CPU = 4;
            __STACK_SIZE = 0x10000;
            __HEAP_SIZE = 0x20000000;
            __TEXT_OFFSET = 0x100000;
        }
    } else {
        quote! {}
    };
